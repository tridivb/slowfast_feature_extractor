...
class Breakfast(torch.utils.data.Dataset):
    """
    Breakfast video loader. Construct the Breakfast video loader, then sample
        ...
        with open(path_to_file, "r") as f:
            for clip_idx, path_label in enumerate(f.read().splitlines()):
                ...
                for idx in range(self._num_clips):
                    ...
                    self._feat_path.append(path.split(".")[0]+".npy")
    ...
    def __getitem__(self, index):
        ...
        for _ in range(self._num_retries):
            ...
            feat_path = self._feat_path[index]
            return frames, label, index, feat_path
        else:
            raise RuntimeError(
